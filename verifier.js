...
async function deploy() {
  ...
  unlockingTx.setOutput(0, (tx) => {
    ...
    .setInputScript(0, (tx, output) => {
      ...
      return zksnake.move(sig, 6, 8, true, new Proof({
        a: new G1Point({
          x: new Int(proof.proof.a[0]),
          y: new Int(proof.proof.a[1]),
        }),
